...
<?php
  $conn = new mysqli("localhost", "root", "", "roomdelivery");
   ...
   $user = $_SESSION["user"];
  $sql = "select * from addorder where  username = '$user' ";
?>
<head>
...
if ($result) {
        while($row = mysqli_fetch_array($result))
        {
             ...
             ?>
               ...
               <form action="otherinvoice.php" id= "A" style="border:0px solid #ccc" method="POST">
                <div class="container">
             <label >OID</label>
             ...
             <input type="text"  value="<?php echo $status ?>"  readonly>
                ...
                <div class="clearfix">
                <button type="submit" class="signupbtn">invoice</button>
                </div>
                </div>     
              </form>
            <?php
